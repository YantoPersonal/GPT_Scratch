"""
Transformer - Feed forward layer (1:25:15)
by: Ieuan Griffiths
...
class BigramLanguageModel(nn.Module):
    def __init__(self):
        ...
        self.sa_heads = MultiHeadAttention(4, n_embd//4)  # MultiHead works out at n_embd at end, from concat.
        self.ffwd = FeedForward(n_embd) # New: Adds a FCL after the heads, of same shape. More thinking before logits.
    ...
    def forward(self, idx, targets=None):
        ...
        x = self.sa_heads(x)  # New: Apply multi heads of self attention.
        x = self.ffwd(x)
